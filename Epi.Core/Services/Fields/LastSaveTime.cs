...
namespace Epi.Fields
{
    ...
    /// LastSaveTime Field
    /// </summary>
    public class LastSaveTimeField : PredefinedDataField, IMirrorable
    {
        ...
        public LastSaveTimeField(View view)
            : base(view)
        {
            Construct();
        }
        ...
        {
            this.Name = ColumnNames.RECORD_LAST_SAVE_TIME;
        ...
        public LastSaveTimeField(View view, XmlElement viewElement)
            : base(view)
        {
        ...
        public LastSaveTimeField(View view, XmlNode fieldNode)
            : base(view)
        {
        ...
        public override MetaFieldType FieldType
        {
            get
            {
                return MetaFieldType.LastSaveTime;
            }
        }
        ...
        protected override void InsertField()
        {
            ...
            {
                throw new System.ApplicationException("LastSaveTime field already exists");
            }
        }
