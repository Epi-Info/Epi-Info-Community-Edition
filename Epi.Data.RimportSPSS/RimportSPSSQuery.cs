...
{
    /// <summary>
    /// RimportSPSS statement and related parameters.
    /// </summary>
    public class RimportSPSSQuery : Query
    {
        #region Constructors
        ...
        public RimportSPSSQuery(string queryStatement)
            : base(queryStatement)
        {
        ...
        /// <summary>
        /// Get RimportSPSS Syntax Insert Into Query Value part
        /// </summary>
        ...
        //// <summary>
        //// Return RimportSPSS syntax query for Recode
        //// </summary>
