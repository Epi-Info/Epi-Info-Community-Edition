...
{   
    ...
    /// </summary>
    public partial class NonExistingConnectionStringDialog : Epi.Data.RimportSPSS.Forms.ConnectionStringDialog
    {
        #region Constructors
        ...
        {
            this.Text = "Create a RimportSPSS database";
            lblInstructions.Text = "Enter information to create the RimportSPSS database.";
        ...
        protected override void OnOkClick()
        {
            if (ValidateInput())
            {
                dbConnectionStringBuilder = new RimportSPSSConnectionStringBuilder();
