...
{
    /// <summary>
    /// Concrete Microsoft JSON File implementation
    /// </summary>
    public partial class JsonFile : OleDbDatabase
    {
        /// <summary>
        /// Default Constructor
        /// </summary>
        ...
        public override string ConnectionString
        {
            ...
            set
            {
                ...
                {
                    connectionString = JsonFile.BuildConnectionString(value, "");
                }
                else
                {
        ...
        {
            string cnnString = BuildConnectionString(Configuration.GetNewInstance().Directories.Project + "\\" + databaseName + ".json", string.Empty);
