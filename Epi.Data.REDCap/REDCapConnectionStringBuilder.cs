...
{
    public class REDCapConnectionStringBuilder : DbConnectionStringBuilder
    {

        private string connString;
        private string certFile;

        public REDCapConnectionStringBuilder() { }
        public REDCapConnectionStringBuilder(string connString) { this.connString = connString; }
