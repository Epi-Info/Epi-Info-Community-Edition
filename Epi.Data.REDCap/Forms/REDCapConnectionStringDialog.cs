...
{
    public partial class REDCapConnectionStringDialog : DialogBase, IConnectionStringGui
    {

        private REDCapConnectionStringBuilder connBuilder;

        public REDCapConnectionStringDialog()
        {
            InitializeComponent();
        ...
        public string ConnectionStringDescription { get { return "REDCap"; } }
